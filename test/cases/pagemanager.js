...
define('modules/test_ctrl3/test_ctrl3', function (require, exports, module) {
    var $ = require('$');
    var page = {
        render: function () {
            argVar = arguments;
...
define('test/cases/pagemanager', function(require) {
    ...
    describe('pagemanager', function () {
        ...
        it('Should render url params page correctly', function () {
            pageManager.loadCommon('test_ctrl','test_action2', '111', {r: '123'});
            argVar[0].should.equal('111');
            argVar[1].r.should.equal('123');
            
            pageManager.loadCommon('test_ctrl3', {r: '1234'});
            argVar[0].r.should.equal('1234');
        });
